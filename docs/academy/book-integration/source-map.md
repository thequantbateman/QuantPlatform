...
|---|---|---|:---:|---|
| Ch. 1 §§1.1–1.1.3, PDF 20–27 | density, expectation, variance, CF, cumulants, moments | `foundation-distributions`, `numerical-fourier-cos` | A/F | Integrated foundation; cross-linked COS |
| Ch. 1 §§1.2–1.2.3, PDF 28–32 | processes, Wiener, martingale, tower | `foundation-brownian-ito`, `foundation-filtrations`, `foundation-conditional-expectation` | A/F | Integrated Brownian; retained deep measure lessons |
| Ch. 1 §1.3, PDF 33–43 | elementary integrands, Itô integral/isometry, representation | `foundation-brownian-ito` | A/F | Integrated core construction and optional depth |
| Ch. 2 §§2.1–2.3, PDF 46–67 | GBM, Itô lemma, lognormal law, dividends, P/Q, estimation | `foundation-gbm-dynamics`, `foundation-measure-change`, `foundation-girsanov` | A/F | Integrated GBM and repaired prerequisites |
| Ch. 3 §§3.1–3.3, PDF 70–96 | contracts, replication, PDE, martingale price, Feynman–Kac, closed form, hedge | `foundation-black-scholes`, `greeks-first-order`, `hedging-pnl` | A/F | Integrated classical foundation and deep links |
